  ...
  <body>
    ...
    <section class="contenedor_usuarios">
      ...
      <form class="form_search" action="buscar_usuario.php" method="post">
        <input type="text" name="busqueda" id="busqueda" placeholder="Buscar" value="<?php echo $busqueda;?>" class="btn_text">
    ...
    WHERE tipo_usuario='profesor' AND  nombre LIKE '%".$busqueda."%' OR apellido_p LIKE '%".$busqueda."%' OR
